...
/*
    CSC 120 Exam 1 Review Problem 1a
    Samantha Student
    Today's Date

    Description:
    Practice System.out.println, arithmetic, if statements.
...
public class MUPanel extends JPanel {
    public MUPanel() {
        ...
        System.out.println("8. " + ( 16 % 4 ) );

        System.out.println("9. " + ( 7654321 / 100 ) );

        System.out.println("10. " + ( 7654321 % 100 ) );

        System.out.println("11. " + ( 2 + 20 * 3 ) );

        System.out.println("12. " + ( 3 * 20 + 2 ) );

        System.out.println("13. " + ( (2 + 20) * 3 ) );

        Integer x = 209;
        Integer y = 321;

        System.out.println("14. " + ( 2*x + y/10 ) );

        System.out.println("15. " + ( 16 + 20 ) );
